        ...
        Seller ->
            case newType of
                ...
                _ ->
                    let
                        _ =
                            maybeDebugLog "Trying to update inType with the wrong currency type" ( initiatorRole prevModel.mode, newType )
                    in
                    prevModel
        ...
        Seller ->
            case newType of
                ...
                _ ->
                    let
                        _ =
                            maybeDebugLog "Trying to update outType with the wrong currency type" ( initiatorRole prevModel.mode, newType )
                    in
                    prevModel
